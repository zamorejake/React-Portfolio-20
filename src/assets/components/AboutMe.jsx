...
const AboutMe = () => {
    return (
      ...
      <body className="h-screen flex flex-col px-1.5 items-center">
        ...
        <p className="pt-12 px-14 text-3xl text-white">Welcome to my corner of the web! I'm Jake Zam, a passionate MERN fullstack developer on a journey to create innovative and immersive digital experiences. With a strong foundation in MongoDB, Express, React, and Node.js, I thrive in crafting dynamic and responsive web applications that not only meet, but exceed expectations.
